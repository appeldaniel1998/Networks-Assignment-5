...
////    unsigned short *massage = paddress;
////    unsigned int sum=0;
////    unsigned short result;
////    for (sum = 0; len > 1; len -= 2)
////        sum += *massage++;
////    if (len == 1)
////        sum += *(unsigned char *) massage;
...
//    icmphdr.icmp_type = ICMP_ECHO;//ICMP massage type
//
//    // Message Code (8 bits): echo request
//    icmphdr.icmp_code = 0;//ICMP type sub-code
//
//    // Identifier (16 bits): some number to trace the response.
//    // It will be copied to the response packet and used to map response to the request sent earlier.
//    // Thus, it serves as a Transaction-ID when we need to make "ping"
//    icmphdr.icmp_id = 18; // hai //echo datagram ID
//
//    // Sequence Number (16 bits): starts at 0
//    icmphdr.icmp_seq = 0; //eco seq #
//
//    // ICMP header checksum (16 bits): set to 0 not to include into checksum calculation
//    icmphdr.icmp_cksum = 0; //validation- check we get the whole packet
//
//    // Combine the packet
